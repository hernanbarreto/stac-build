...
| G1 | pending | 7efcb63 | `pose_refine.enabled: false` — run6 geometry (poses untouched) + Phase D density (backfill + conf 10) + B | | question: run6 solidity (chimney clavada) + F2 coverage = new best? |
