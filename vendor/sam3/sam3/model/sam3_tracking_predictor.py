...
class Sam3TrackerPredictor(Sam3TrackerBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bf16_context = torch.autocast(device_type=device_type, dtype=autocast_dtype)
    ...
    def init_state(
        ...
        if offload_state_to_cpu:
            ...
            inference_state["storage_device"] = torch.device("cuda") if torch.cuda.is_available() else torch.device("cpu")
