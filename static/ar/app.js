...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function Ab(s,e,t){let n=new Float32Array(Ws),i=new R(0,1,0);return new Dn({name:"SphericalGaussianBlur",defines:{n:Ws,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Al(),fragmentShader:`
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function zp(){return new Dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Al(),fragmentShader:`
		...
		`,blending:pi,depthTest:!1,depthWrite:!1})}function Hp(){return new Dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Al(),fragmentShader:`
	...
	`}function wb(s){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){let c=o.mapping,l=c===Lc||c===Dc,u=c===rs||c===Bs;if(l||u){let h=e.get(o),f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new Ml(s)),h=l?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{let d=o.image;return l&&d&&d.height>0||u&&d&&i(d)?(t===null&&(t=new Ml(s)),h=l?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function i(o){let c=0,l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function r(o){let c=o.target;c.removeEventListener("dispose",r);let l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Eb(s){let e={};function t(n){if(e[n]!==void 0)return e[n];let i=s.getExtension(n);return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let i=t(n);return i===null&&vr("WebGLRenderer: "+n+" extension not supported."),i}}}function Rb(s,e,t,n){let i={},r=new WeakMap;function a(h){let f=h.target;f.index!==null&&e.remove(f.index);for(let g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete i[f.id];let d=r.get(f);d&&(e.remove(d),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return i[f.id]===!0||(f.addEventListener("dispose",a),i[f.id]=!0,t.memory.geometries++),f}function c(h){let f=h.attributes;for(let d in f)e.update(f[d],s.ARRAY_BUFFER)}function l(h){let f=[],d=h.index,g=h.attributes.position,x=0;if(d!==null){let _=d.array;x=d.version;for(let b=0,y=_.length;b<y;b+=3){let v=_[b+0],A=_[b+1],w=_[b+2];f.push(v,A,A,w,w,v)}}else if(g!==void 0){let _=g.array;x=g.version;for(let b=0,y=_.length/3-1;b<y;b+=3){let v=b+0,A=b+1,w=b+2;f.push(v,A,A,w,w,v)}}else return;let m=new(Mu(f)?Ta:Ma)(f,1);m.version=x;let p=r.get(h);p&&e.remove(p),r.set(h,m)}function u(h){let f=r.get(h);if(f){let d=h.index;d!==null&&f.version<d.version&&l(h)}else l(h);return r.get(h)}return{get:o,update:c,getWireframeAttribute:u}}function Cb(s,e,t){let n;function i(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,d){s.drawElements(n,d,r,f*a),t.update(d,n,1)}function l(f,d,g){g!==0&&(s.drawElementsInstanced(n,d,r,f*a,g),t.update(d,n,g))}function u(f,d,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,r,f,0,g);let m=0;for(let p=0;p<g;p++)m+=d[p];t.update(m,n,1)}function h(f,d,g,x){if(g===0)return;let m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<f.length;p++)l(f[p]/a,d[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(n,d,0,r,f,0,x,0,g);let p=0;for(let _=0;_<g;_++)p+=d[_]*x[_];t.update(p,n,1)}}this.setMode=i,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Pb(s){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case s.TRIANGLES:t.triangles+=o*(r/3);break;case s.LINES:t.lines+=o*(r/2);break;case s.LINE_STRIP:t.lines+=o*(r-1);break;case s.LINE_LOOP:t.lines+=o*r;break;case s.POINTS:t.points+=o*r;break;default:Ce("WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Ib(s,e,t){let n=new WeakMap,i=new yt;function r(a,o,c){let l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0,f=n.get(o);if(f===void 0||f.count!==h){let S=function(){w.dispose(),n.delete(o),o.removeEventListener("dispose",S)};f!==void 0&&f.texture.dispose();let d=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,x=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],_=o.morphAttributes.color||[],b=0;d===!0&&(b=1),g===!0&&(b=2),x===!0&&(b=3);let y=o.attributes.position.count*b,v=1;y>e.maxTextureSize&&(v=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);let A=new Float32Array(y*v*4*h),w=new Sa(A,y,v,h);w.type=hn,w.needsUpdate=!0;let P=b*4;for(let M=0;M<h;M++){let C=m[M],L=p[M],D=_[M],O=y*v*4*M;for(let z=0;z<C.count;z++){let H=z*P;d===!0&&(i.fromBufferAttribute(C,z),A[O+H+0]=i.x,A[O+H+1]=i.y,A[O+H+2]=i.z,A[O+H+3]=0),g===!0&&(i.fromBufferAttribute(L,z),A[O+H+4]=i.x,A[O+H+5]=i.y,A[O+H+6]=i.z,A[O+H+7]=0),x===!0&&(i.fromBufferAttribute(D,z),A[O+H+8]=i.x,A[O+H+9]=i.y,A[O+H+10]=i.z,A[O+H+11]=D.itemSize===4?i.w:1)}}f={count:h,texture:w,size:new fe(y,v)},n.set(o,f),o.addEventListener("dispose",S)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",a.morphTexture,t);else{let d=0;for(let x=0;x<l.length;x++)d+=l[x];let g=o.morphTargetsRelative?1:1-d;c.getUniforms().setValue(s,"morphTargetBaseInfluence",g),c.getUniforms().setValue(s,"morphTargetInfluences",l)}c.getUniforms().setValue(s,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(s,"morphTargetsTextureSize",f.size)}return{update:r}}function Lb(s,e,t,n){let i=new WeakMap;function r(c){let l=n.render.frame,u=c.geometry,h=e.get(c,u);if(i.get(h)!==l&&(e.update(h),i.set(h,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),i.get(c)!==l&&(t.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){let f=c.skeleton;i.get(f)!==l&&(f.update(),i.set(f,l))}return h}function a(){i=new WeakMap}function o(c){let l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}var Db={[au]:"LINEAR_TONE_MAPPING",[ou]:"REINHARD_TONE_MAPPING",[cu]:"CINEON_TONE_MAPPING",[lu]:"ACES_FILMIC_TONE_MAPPING",[uu]:"AGX_TONE_MAPPING",[fu]:"NEUTRAL_TONE_MAPPING",[hu]:"CUSTOM_TONE_MAPPING"};function Nb(s,e,t,n,i){let r=new In(e,t,{type:s,depthBuffer:n,stencilBuffer:i}),a=new In(e,t,{type:mi,depthBuffer:!1,stencilBuffer:!1}),o=new vt;o.setAttribute("position",new Ct([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Ct([0,2,0,0,2,0],2));let c=new mc({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new ct(o,c),u=new ns(-1,1,1,-1,0,1),h=null,f=null,d=!1,g,x=null,m=[],p=!1;this.setSize=function(_,b){r.setSize(_,b),a.setSize(_,b);for(let y=0;y<m.length;y++){let v=m[y];v.setSize&&v.setSize(_,b)}},this.setEffects=function(_){m=_,p=m.length>0&&m[0].isRenderPass===!0;let b=r.width,y=r.height;for(let v=0;v<m.length;v++){let A=m[v];A.setSize&&A.setSize(b,y)}},this.begin=function(_,b){if(d||_.toneMapping===$n&&m.length===0)return!1;if(x=b,b!==null){let y=b.width,v=b.height;(r.width!==y||r.height!==v)&&this.setSize(y,v)}return p===!1&&_.setRenderTarget(r),g=_.toneMapping,_.toneMapping=$n,!0},this.hasRenderPass=function(){return p},this.end=function(_,b){_.toneMapping=g,d=!0;let y=r,v=a;for(let A=0;A<m.length;A++){let w=m[A];if(w.enabled!==!1&&(w.render(_,v,y,b),w.needsSwap!==!1)){let P=y;y=v,v=P}}if(h!==_.outputColorSpace||f!==_.toneMapping){h=_.outputColorSpace,f=_.toneMapping,c.defines={},Ve.getTransfer(h)===tt&&(c.defines.SRGB_TRANSFER="");let A=Db[f];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=y.texture,_.setRenderTarget(x),_.render(l,u),x=null,d=!1},this.isCompositing=function(){return d},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),c.dispose()}}var am=new Ht,Fu=new ts(1,1),om=new Sa,cm=new lc,lm=new wa,Vp=[],Gp=[],Wp=new Float32Array(16),Xp=new Float32Array(9),qp=new Float32Array(4);function Br(s,e,t){let n=s[0];if(n<=0||n>0)return s;let i=e*t,r=Vp[i];if(r===void 0&&(r=new Float32Array(i),Vp[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function Vt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Gt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function wl(s,e){let t=Gp[e];t===void 0&&(t=new Int32Array(e),Gp[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function Fb(s,e){let t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function Ub(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Vt(t,e))return;s.uniform2fv(this.addr,e),Gt(t,e)}}function Ob(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Vt(t,e))return;s.uniform3fv(this.addr,e),Gt(t,e)}}function Bb(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Vt(t,e))return;s.uniform4fv(this.addr,e),Gt(t,e)}}function kb(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Vt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Gt(t,e)}else{if(Vt(t,n))return;qp.set(n),s.uniformMatrix2fv(this.addr,!1,qp),Gt(t,n)}}function zb(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Vt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Gt(t,e)}else{if(Vt(t,n))return;Xp.set(n),s.uniformMatrix3fv(this.addr,!1,Xp),Gt(t,n)}}function Hb(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Vt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Gt(t,e)}else{if(Vt(t,n))return;Wp.set(n),s.uniformMatrix4fv(this.addr,!1,Wp),Gt(t,n)}}function Vb(s,e){let t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function Gb(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Vt(t,e))return;s.uniform2iv(this.addr,e),Gt(t,e)}}function Wb(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Vt(t,e))return;s.uniform3iv(this.addr,e),Gt(t,e)}}function Xb(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Vt(t,e))return;s.uniform4iv(this.addr,e),Gt(t,e)}}function qb(s,e){let t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function Yb(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Vt(t,e))return;s.uniform2uiv(this.addr,e),Gt(t,e)}}function jb(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Vt(t,e))return;s.uniform3uiv(this.addr,e),Gt(t,e)}}function Kb(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Vt(t,e))return;s.uniform4uiv(this.addr,e),Gt(t,e)}}function Zb(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Fu.compareFunction=t.isReversedDepthBuffer()?yl:bl,r=Fu):r=am,t.setTexture2D(e||r,i)}function Jb(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||cm,i)}function $b(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||lm,i)}function Qb(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||om,i)}function ey(s){switch(s){case 5126:return Fb;case 35664:return Ub;case 35665:return Ob;case 35666:return Bb;case 35674:return kb;case 35675:return zb;case 35676:return Hb;case 5124:case 35670:return Vb;case 35667:case 35671:return Gb;case 35668:case 35672:return Wb;case 35669:case 35673:return Xb;case 5125:return qb;case 36294:return Yb;case 36295:return jb;case 36296:return Kb;case 35678:case 36198:case 36298:case 36306:case 35682:return Zb;case 35679:case 36299:case 36307:return Jb;case 35680:case 36300:case 36308:case 36293:return $b;case 36289:case 36303:case 36311:case 36292:return Qb}}function ty(s,e){s.uniform1fv(this.addr,e)}function ny(s,e){let t=Br(e,this.size,2);s.uniform2fv(this.addr,t)}function iy(s,e){let t=Br(e,this.size,3);s.uniform3fv(this.addr,t)}function sy(s,e){let t=Br(e,this.size,4);s.uniform4fv(this.addr,t)}function ry(s,e){let t=Br(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function ay(s,e){let t=Br(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function oy(s,e){let t=Br(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function cy(s,e){s.uniform1iv(this.addr,e)}function ly(s,e){s.uniform2iv(this.addr,e)}function hy(s,e){s.uniform3iv(this.addr,e)}function uy(s,e){s.uniform4iv(this.addr,e)}function fy(s,e){s.uniform1uiv(this.addr,e)}function dy(s,e){s.uniform2uiv(this.addr,e)}function py(s,e){s.uniform3uiv(this.addr,e)}function my(s,e){s.uniform4uiv(this.addr,e)}function gy(s,e,t){let n=this.cache,i=e.length,r=wl(t,i);Vt(n,r)||(s.uniform1iv(this.addr,r),Gt(n,r));let a;this.type===s.SAMPLER_2D_SHADOW?a=Fu:a=am;for(let o=0;o!==i;++o)t.setTexture2D(e[o]||a,r[o])}function xy(s,e,t){let n=this.cache,i=e.length,r=wl(t,i);Vt(n,r)||(s.uniform1iv(this.addr,r),Gt(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||cm,r[a])}function _y(s,e,t){let n=this.cache,i=e.length,r=wl(t,i);Vt(n,r)||(s.uniform1iv(this.addr,r),Gt(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||lm,r[a])}function by(s,e,t){let n=this.cache,i=e.length,r=wl(t,i);Vt(n,r)||(s.uniform1iv(this.addr,r),Gt(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||om,r[a])}function yy(s){switch(s){case 5126:return ty;case 35664:return ny;case 35665:return iy;case 35666:return sy;case 35674:return ry;case 35675:return ay;case 35676:return oy;case 5124:case 35670:return cy;case 35667:case 35671:return ly;case 35668:case 35672:return hy;case 35669:case 35673:return uy;case 5125:return fy;case 36294:return dy;case 36295:return py;case 36296:return my;case 35678:case 36198:case 36298:case 36306:case 35682:return gy;case 35679:case 36299:case 36307:return xy;case 35680:case 36300:case 36308:case 36293:return _y;case 36289:case 36303:case 36311:case 36292:return by}}var Uu=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=ey(t.type)}},Ou=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=yy(t.type)}},Bu=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let i=this.seq;for(let r=0,a=i.length;r!==a;++r){let o=i[r];o.setValue(e,t[o.id],n)}}},Du=/(\w+)(\])?(\[|\.)?/g;function Yp(s,e){s.seq.push(e),s.map[e.id]=e}function vy(s,e,t){let n=s.name,i=n.length;for(Du.lastIndex=0;;){let r=Du.exec(n),a=Du.lastIndex,o=r[1],c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===i){Yp(t,l===void 0?new Uu(o,s,e):new Ou(o,s,e));break}else{let h=t.map[o];h===void 0&&(h=new Bu(o),Yp(t,h)),t=h}}}var Or=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){let o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);vy(o,c,this)}let i=[],r=[];for(let a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?i.push(a):r.push(a);i.length>0&&(this.seq=i.concat(r))}setValue(e,t,n,i){let r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){let i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){let o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,i)}}static seqWithValue(e,t){let n=[];for(let i=0,r=e.length;i!==r;++i){let a=e[i];a.id in t&&n.push(a)}return n}};function jp(s,e,t){let n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}var Sy=37297,My=0;function Ty(s,e){let t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=i;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}var Kp=new Oe;function Ay(s){Ve._getMatrix(Kp,Ve.workingColorSpace,s);let e=`mat3( ${Kp.elements.map(t=>t.toFixed(4))} )`;switch(Ve.getTransfer(s)){case ba:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return Te("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Zp(s,e,t){let n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let a=/ERROR: 0:(\d+)/.exec(r);if(a){let o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+Ty(s.getShaderSource(e),o)}else return r}function wy(s,e){let t=Ay(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}var Ey={[au]:"Linear",[ou]:"Reinhard",[cu]:"Cineon",[lu]:"ACESFilmic",[uu]:"AgX",[fu]:"Neutral",[hu]:"Custom"};function Ry(s,e){let t=Ey[e];return t===void 0?(Te("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Sl=new R;function Cy(){Ve.getLuminanceCoefficients(Sl);let s=Sl.x.toFixed(4),e=Sl.y.toFixed(4),t=Sl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Py(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(io).join(`
`)}function Iy(s){let e=[];for(let t in s){let n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Ly(s,e){let t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){let r=s.getActiveAttrib(e,i),a=r.name,o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function io(s){return s!==""}function Jp(s,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function $p(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var Dy=/^[ \t]*#include +<([\w\d./]+)>/gm;function ku(s){return s.replace(Dy,Fy)}var Ny=new Map;function Fy(s,e){let t=Be[e];if(t===void 0){let n=Ny.get(e);if(n!==void 0)t=Be[n],Te('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ku(t)}var Uy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Qp(s){return s.replace(Uy,Oy)}function Oy(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function em(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}var By={[Ya]:"SHADOWMAP_TYPE_PCF",[Ir]:"SHADOWMAP_TYPE_VSM"};function ky(s){return By[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var zy={[rs]:"ENVMAP_TYPE_CUBE",[Bs]:"ENVMAP_TYPE_CUBE",[ja]:"ENVMAP_TYPE_CUBE_UV"};function Hy(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":zy[s.envMapMode]||"ENVMAP_TYPE_CUBE"}var Vy={[Bs]:"ENVMAP_MODE_REFRACTION"};function Gy(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":Vy[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Wy={[ru]:"ENVMAP_BLENDING_MULTIPLY",[_p]:"ENVMAP_BLENDING_MIX",[bp]:"ENVMAP_BLENDING_ADD"};function Xy(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":Wy[s.combine]||"ENVMAP_BLENDING_NONE"}function qy(s){let e=s.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Yy(s,e,t,n){let i=s.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=ky(t),l=Hy(t),u=Gy(t),h=Xy(t),f=qy(t),d=Py(t),g=Iy(r),x=i.createProgram(),m,p,_=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        </div>`,i.querySelector(".open").onclick=()=>{let a=i.querySelector(".ck-mesh").checked,o=i.querySelector(".ck-cloud").checked;if(!a&&!o){wn("Pick mesh, cloud, or both");return}SS(n,a,o)},s.appendChild(i)}}catch(e){s.innerHTML=`<div class="empty">Backend unreachable: ${e}</div>`}}var Mt,ps,At,sa,qt,mn,yi,ki,bi,ms=null,$f=null,jf="local-floor",ti=null,gs=[],bo=null,nh="",ah=null,na=null,vo=[],rh=1,ia=[[1,"1:1"],[.1,"1:10"],[.02,"1:50"]],xs=0,zi="move",Kf=!0,_o=new Map;function _S(){Mt=new Tl({antialias:!0,alpha:!0}),Mt.setClearColor(0,0),Mt.setPixelRatio(Math.min(window.devicePixelRatio,2)),Mt.setSize(innerWidth,innerHeight),Mt.xr.enabled=!0,Je("canvas-wrap").appendChild(Mt.domElement),ps=new Ra,At=new Ut(60,innerWidth/innerHeight,.02,300),At.position.set(4,3,4),ps.add(new za(16777215,4478310,1.1));let s=new Os(16777215,1.2);s.position.set(3,10,4),ps.add(s),qt=new Zt,mn=new Zt,yi=new Zt,ki=new Zt,qt.add(mn,yi,ki),ps.add(qt),sa=new Pl(At,Mt.domElement),sa.target.set(0,1,0),bi=new ct(new Ua(.07,.09,32).rotateX(-Math.PI/2),new $t({color:4906624})),bi.matrixAutoUpdate=!1,bi.visible=!1,ps.add(bi),window.addEventListener("resize",()=>{At.aspect=innerWidth/innerHeight,At.updateProjectionMatrix(),Mt.setSize(innerWidth,innerHeight)}),Mt.setAnimationLoop(bS),DS(),zS()}function bS(s,e){if(e&&ms){let t=e.getHitTestResults(ms);if(t.length){let n=t[0].getPose($f);bi.visible=zi==="move",bi.matrix.fromArray(n.transform.matrix)}else bi.visible=!1}ES(),sa.enabled=!Mt.xr.isPresenting,Mt.render(ps,At)}async function yS(s){let e=new El;e.setMeshoptDecoder(_m);let n=(await e.loadAsync(`${yo}/api/ar/mesh/${encodeURIComponent(s)}`)).scene;n.traverse(i=>{i.isMesh&&(i.geometry.computeBoundsTree(),vo.push(i),_o.set(i,i.material))}),mn.add(n),fg()}async function vS(s){let e=await fetch(`${yo}/api/ar/cloud/${encodeURIComponent(s)}`);if(!e.ok)throw new Error(`cloud HTTP ${e.status}`);let t=await e.arrayBuffer(),n=new DataView(t);if(n.getUint32(0,!1)!==1095910193)throw new Error("bad ARC1 magic");let i=n.getUint32(4,!0),r=new Float32Array(t,32,i*3),a=new Uint8Array(t,32+i*12,i*3),o=new Float32Array(i*3);for(let u=0;u<i*3;u++)o[u]=a[u]/255;let c=new vt;c.setAttribute("position",new ot(r,3)),c.setAttribute("color",new ot(o,3));let l=new li(c,new es({size:.014,vertexColors:!0,sizeAttenuation:!0}));l.userData.isCloud=!0,mn.add(l),vo.push(l)}function fg(){mn.traverse(s=>{if(s.isMesh)if(Kf){if(!s.userData.fbMat){let e=_o.get(s);s.userData.fbMat=new $t({map:e&&e.map?e.map:null,vertexColors:!!(e&&e.vertexColors),color:e&&e.color?e.color.clone():new Re(16777215)})}s.material=s.userData.fbMat}else _o.has(s)&&(s.material=_o.get(s))})}async function SS(s,e,t){ah=s,Je("home").style.display="none",Je("viewer").style.display="block",Je("v-title").textContent=s.id,Mt||_S(),MS(),th(!0,`Loading ${s.id}\u2026`);try{e&&(th(!0,"Loading mesh\u2026"),await yS(s.id)),t&&(th(!0,"Loading point cloud\u2026"),await vS(s.id)),na=null,s.floor_transform&&(na=new ge().set(...s.floor_transform),mn.matrixAutoUpdate=!1,mn.matrix.copy(na),mn.matrixWorldNeedsUpdate=!0),Qf(),oh("move"),wn(s.has_ai?"Tip: the AI \u2726 button answers with real measurements":"AI disabled: this session has no instance store (run segmentation)")}catch(n){wn(`Load failed: ${n.message||n}`,6e3)}finally{th(!1)}CS()}function MS(){for(let s of[mn,yi,ki])for(;s.children.length;)s.children.pop().traverse?.(t=>{t.geometry?.dispose?.()});vo=[],_o.clear(),mn.matrixAutoUpdate=!0,mn.matrix.identity(),mn.position.set(0,0,0),mn.quaternion.identity(),na=null,qt.position.set(0,0,0),qt.quaternion.identity(),ra(0)}function Qf(){let s=new We().setFromObject(mn);if(s.isEmpty())return;let e=s.getCenter(new R),t=s.getSize(new R).length();sa.target.copy(e),At.position.copy(e).add(new R(t*.4,t*.3,t*.4)),At.near=Math.max(t/1e3,.01),At.far=t*20,At.updateProjectionMatrix()}function TS(s,e,t=!1){let n=t?30:44,i=t?10:16,r=document.createElement("canvas"),a=r.getContext("2d");return a.font=`600 ${n}px system-ui`,r.width=Math.max(a.measureText(s).width+i*2,t?40:100),r.height=n+i*2,a.font=`600 ${n}px system-ui`,a.fillStyle=e?"rgba(46,160,67,0.95)":"rgba(24,29,36,0.92)",a.fillRect(0,0,r.width,r.height),t||(a.strokeStyle=e?"#4ade80":"#57606d",a.lineWidth=4,a.strokeRect(2,2,r.width-4,r.height-4)),a.fillStyle="#fff",a.textAlign="center",a.textBaseline="middle",a.fillText(s,r.width/2,r.height/2),{tex:new Er(r),aspect:r.width/r.height}}function hg(s,e,t=.055,n=!1){let i=new Ar(new Ns({depthTest:!1}));return i.renderOrder=999,i.userData={action:s,hudButton:!n},i.userData.redraw=(r,a=!1)=>{let{tex:o,aspect:c}=TS(r,a,n);i.material.map?.dispose(),i.material.map=o,i.material.needsUpdate=!0,i.scale.set(t*c,t,1)},i.userData.redraw(e),i}function dg(){let t=-(gs.reduce((n,i)=>n+i.scale.x,0)+.012*(gs.length-1))/2;for(let n of gs)n.position.set(t+n.scale.x/2,0,0),t+=n.scale.x+.012;bo.position.set(0,.062,0)}function AS(){pg(),ti=new Zt,gs=[];let s=[["move","Move"],["dist","Dist"],["angle","Ang"],["vol","Vol"],["scale",ia[xs][1]],["clear","Clear"],["exit","\u2715"]];for(let[e,t]of s){let n=hg(e,t);gs.push(n),ti.add(n)}bo=hg("","",.034,!0),ti.add(bo),dg(),Zf(),ps.add(ti)}function pg(){ti&&ps.remove(ti),ti=null,gs=[],bo=null}function Zf(){if(ti){for(let s of gs)s.userData.action==="scale"?s.userData.redraw(ia[xs][1]):s.userData.redraw(wS(s.userData.action),s.userData.action===zi);bo.userData.redraw(`${zi} \xB7 ${ia[xs][1]} \xB7 blend:${nh||"?"}${ms?" \xB7 hit-test":""}`),dg()}}function wS(s){return{move:"Move",dist:"Dist",angle:"Ang",vol:"Vol",clear:"Clear",exit:"\u2715"}[s]||s}function ES(){if(!ti||!Mt.xr.isPresenting)return;let s=Mt.xr.getCamera(),e=s.quaternion,t=s.position.clone().addScaledVector(new R(0,0,-1).applyQuaternion(e),.62).addScaledVector(new R(0,-1,0).applyQuaternion(e),.2);ti.position.lerp(t,.35),ti.quaternion.slerp(e,.35)}function RS(s){if(s==="exit"){Mt.xr.getSession()?.end();return}if(s==="scale"){ra(xs+1),Zf();return}if(s==="clear"){_g();return}oh(s),Zf()}async function CS(){let s=Je("btn-ar"),e=navigator.xr&&await navigator.xr.isSessionSupported?.("immersive-ar").catch(()=>!1);_s("xr-support",{immersiveAR:!!e}),s.style.display=e?"block":"none",e||wn("WebXR AR not available in this browser \u2014 3D mode only",4e3),s.onclick=PS}async function PS(){try{let s=await navigator.xr.requestSession("immersive-ar",{requiredFeatures:[],optionalFeatures:["local-floor","hit-test","dom-overlay"],domOverlay:{root:Je("overlay")}}),e="local-floor";try{await s.requestReferenceSpace("local-floor")}catch{e="local"}Mt.xr.setReferenceSpaceType(e),jf=e,await Mt.xr.setSession(s),$f=Mt.xr.getReferenceSpace(),nh=s.environmentBlendMode||"?";try{let n=await s.requestReferenceSpace("viewer");ms=await s.requestHitTestSource?.({space:n})||null}catch{ms=null}ra(0),qt.position.set(0,0,0),ed(0,-6),e==="local"&&(qt.position.y-=1.4),AS();let t=!!s.domOverlayState;_s("ar-start",{blend:nh,refType:e,hitTest:!!ms,domOverlay:t,session:ah?.id,interactionMode:s.interactionMode||null}),s.addEventListener("select",IS),s.addEventListener("end",()=>{let n=`AR caps \u2014 blend:${nh} \xB7 hit-test:${!!ms} \xB7 dom-overlay:${t} \xB7 ref:${jf}`;ms=null,bi.visible=!1,pg(),ra(0),qt.position.set(0,0,0),Qf(),wn(n,12e3)}),wn("Tap to place (Move) \u2014 switch tools below")}catch(s){_s("ar-error",{msg:String(s.message||s)}),wn(`AR failed: ${s.message||s}`,5e3)}}function IS(s){let t=s.frame.getPose(s.inputSource.targetRaySpace,$f),n=null,i=null;if(t){let r=new ge().fromArray(t.transform.matrix);n=new R().setFromMatrixPosition(r),i=new R(0,0,-1).applyMatrix4(new ge().extractRotation(r)).normalize(),qn.set(n,i),qn.camera=Mt.xr.getCamera();let a=qn.intersectObjects(gs,!1);if(a.length){RS(a[0].object.userData.action);return}}if(zi==="move"){if(bi.visible){let r=new R,a=new zt,o=new R;bi.matrix.decompose(r,a,o),qt.position.copy(r)}else{let r=Mt.xr.getCamera(),a=new R(0,0,-1).applyQuaternion(r.quaternion);qt.position.copy(r.position).addScaledVector(a,2),qt.position.y=jf==="local"?r.position.y-1.4:0}return}n&&i&&LS(n,i)}var qn=new Xa;qn.firstHitOnly=!0;function LS(s,e){qn.set(s,e),qn.params.Points.threshold=.02*rh*3;let t=qn.intersectObjects(vo,!1);if(!t.length){wn("No surface under the tap");return}let n=t[0].point.clone(),i=qt.worldToLocal(n.clone());mg(i)}function DS(){let s=null;Mt.domElement.addEventListener("pointerdown",e=>{s=[e.clientX,e.clientY]}),Mt.domElement.addEventListener("pointerup",e=>{if(Mt.xr.isPresenting||!s)return;let t=e.clientX-s[0],n=e.clientY-s[1];if(s=null,Math.hypot(t,n)>8)return;let i=new fe(e.clientX/innerWidth*2-1,-(e.clientY/innerHeight)*2+1);if(zi==="move"){Xt.on&&kS(i);return}qn.setFromCamera(i,At),qn.params.Points.threshold=.02*rh*3;let r=qn.intersectObjects(vo,!1);r.length&&mg(qt.worldToLocal(r[0].point.clone()))})}var An=[];function oh(s){zi=s,An=[],document.querySelectorAll("#toolbar [data-tool]").forEach(t=>t.classList.toggle("active",t.dataset.tool===s)),wn({move:"Move: tap the floor to place the model (AR)",dist:"Distance: tap two points",angle:"Angle: tap 3 points (vertex second)",vol:"Volume: tap 2 base corners, then a height point"}[s]||s)}function NS(s){return s>=1?`${s.toFixed(2)} m`:`${(s*100).toFixed(1)} cm`}function Yf(s,e=16761095){let t=new ct(new Rr(.02,12,12),new $t({color:e}));return t.position.copy(s),yi.add(t),t}function ug(s,e=16761095){let t=new vt().setFromPoints(s),n=new Hn(t,new Pi({color:e}));return yi.add(n),n}function ih(s,e,t=yi){let r=document.createElement("canvas"),a=r.getContext("2d");a.font="600 34px system-ui",r.width=a.measureText(s).width+8*2,r.height=34+8*2,a.font="600 34px system-ui",a.fillStyle="rgba(12,16,20,0.85)",a.fillRect(0,0,r.width,r.height),a.fillStyle="#ffd866",a.textBaseline="middle",a.fillText(s,8,r.height/2);let o=new Er(r),c=new Ar(new Ns({map:o,depthTest:!1})),l=.12;return c.scale.set(l*r.width/r.height,l,1),c.position.copy(e),t.add(c),c}function mg(s){if(zi==="dist"){if(An.push(s),Yf(s),An.length===2){let[e,t]=An;ug([e,t]),ih(NS(e.distanceTo(t)),e.clone().add(t).multiplyScalar(.5)),An=[]}}else if(zi==="angle"){if(An.push(s),Yf(s,7979263),An.length===3){let[e,t,n]=An;ug([e,t,n],7979263);let i=e.clone().sub(t).normalize(),r=n.clone().sub(t).normalize(),a=Nn.radToDeg(Math.acos(Nn.clamp(i.dot(r),-1,1)));ih(`${a.toFixed(1)}\xB0`,t.clone().addScaledVector(i.clone().add(r).normalize(),.25)),An=[]}}else if(zi==="vol"&&(An.push(s),Yf(s,4906624),An.length===3)){let[e,t,n]=An,i=Math.min(e.y,t.y),r=Math.max(Math.abs(n.y-i),.05),a=new R(Math.min(e.x,t.x),i,Math.min(e.z,t.z)),o=new R(Math.max(e.x,t.x),i+r,Math.max(e.z,t.z)),c=o.clone().sub(a),l=c.x*c.y*c.z,u=new Ki(c.x,c.y,c.z),h=new ct(u,new $t({color:4906624,transparent:!0,opacity:.18,depthWrite:!1}));h.position.copy(a).add(c.clone().multiplyScalar(.5)),yi.add(h),yi.add(new ci(new Na(u),new Pi({color:4906624}))).children.at(-1).position.copy(h.position),ih(`${c.x.toFixed(2)}\xD7${c.z.toFixed(2)}\xD7${c.y.toFixed(2)} m = ${l.toFixed(2)} m\xB3`,h.position.clone().setY(o.y+.1)),An=[]}}function Jf(s,e=""){let t=document.createElement("div");return t.className=`msg ${e}`,t.innerHTML=s,Je("msgs").appendChild(t),Je("msgs").scrollTop=Je("msgs").scrollHeight,t}function ta(s){return String(s).replace(/[&<>]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[e])}function sh(s,e=[],t=0){if(t>6||e.length>20||s==null)return e;if(Array.isArray(s))s.length===3&&s.every(n=>typeof n=="number")?e.push(new R(s[0],s[1],s[2])):s.forEach(n=>sh(n,e,t+1));else if(typeof s=="object")for(let[n,i]of Object.entries(s))(/pos|point|center|centroid|p1|p2|start|end|corner/i.test(n)||typeof i=="object")&&sh(i,e,t+1);return e}async function FS(s){Jf(ta(s),"q");let e=Jf("\u2026thinking (deterministic tools measure, the VLM narrates)");try{let t=await fetch(`${yo}/api/spatial_qa`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({question:s,session_id:ah.id})}),n=await t.json();if(t.status===503&&n.status==="loading"){e.innerHTML="\u23F3 The VLM is loading on the pod GPU (it frees VRAM during reconstruction) \u2014 ask again in ~2 minutes.";return}if(!t.ok){e.innerHTML=`\u26A0 ${ta(n.error||t.status)}`;return}let i=ta(n.answer||"(no answer)");if(n.tool_trace?.length){let a=n.tool_trace.map(o=>`\u25B8 ${ta(o.tool||o.name||"?")}(${ta(JSON.stringify(o.args??o.arguments??{}))})`).join(`
`);i+=`<div class="trace">${a}</div>`}for(e.innerHTML=i;ki.children.length;)ki.children.pop();let r=sh(n.tool_trace).map(a=>na?a.applyMatrix4(na):a);r.slice(0,20).forEach((a,o)=>{let c=new ct(new Rr(.03,12,12),new $t({color:14048689}));c.position.copy(a),ki.add(c),o<8&&ih(`\u2726${o+1}`,a.clone().add(new R(0,.12,0)),ki)}),r.length&&wn(`${r.length} AI reference point(s) marked in the scene`)}catch(t){e.innerHTML=`\u26A0 ${ta(t.message||t)}`}}var Xt={on:!1,stream:null,yawPitch:null,initialAlpha:null,screenO:0,baseFov:62};function US(s){let e=Nn.degToRad(s.alpha||0),t=Nn.degToRad(s.beta||0),n=Nn.degToRad(s.gamma||0);Xt.initialAlpha===null&&(Xt.initialAlpha=e);let i=new Ln(t-Math.PI/2,e-Xt.initialAlpha,-n,"YXZ"),r=new zt().setFromEuler(i);return r.multiply(new zt().setFromAxisAngle(new R(0,0,1),-Nn.degToRad(Xt.screenO))),r}function gg(s){Xt.on&&At.quaternion.copy(US(s))}async function OS(){if(Xt.on){xg();return}try{if(typeof DeviceOrientationEvent<"u"&&typeof DeviceOrientationEvent.requestPermission=="function"&&await DeviceOrientationEvent.requestPermission()!=="granted"){wn("Motion permission denied");return}let s=await navigator.mediaDevices.getUserMedia({video:{facingMode:"environment"},audio:!1}),e=Je("camfeed");e.srcObject=s,e.style.display="block",await e.play(),Xt.stream=s,Xt.on=!0,Xt.initialAlpha=null,Xt.screenO=(screen.orientation?.angle??window.orientation)||0,sa.enabled=!1,At.position.set(0,1.5,0),At.fov=Xt.baseFov,At.updateProjectionMatrix(),ra(0),qt.position.set(0,0,0),ed(0,-6),window.addEventListener("deviceorientation",gg),oh("move"),Je("btn-camar").classList.add("active"),_s("camar-start",{fov:Xt.baseFov}),wn("Cam AR: pan the phone \xB7 tap the floor to re-place \xB7 pinch = FOV calibration");try{navigator.wakeLock?.request("screen")}catch{}}catch(s){_s("camar-error",{msg:String(s.message||s)}),wn(`Cam AR failed: ${s.message||s}`,5e3)}}function xg(){Xt.on=!1,Xt.stream?.getTracks().forEach(e=>e.stop()),Xt.stream=null;let s=Je("camfeed");s.srcObject=null,s.style.display="none",window.removeEventListener("deviceorientation",gg),Je("btn-camar").classList.remove("active"),sa.enabled=!0,At.fov=60,At.updateProjectionMatrix(),qt.position.set(0,0,0),Qf()}function ed(s,e){let t=new We().setFromObject(mn);if(t.isEmpty())return;let n=t.getCenter(new R);qt.position.x+=s-n.x,qt.position.z+=e-n.z,qt.position.y+=-t.min.y}var BS=new jt(new R(0,1,0),0);function kS(s){qn.setFromCamera(s,At);let e=new R;qn.ray.intersectPlane(BS,e)&&ed(e.x,e.z)}var xo=null;function zS(){let s=Mt.domElement;s.addEventListener("touchmove",e=>{if(!Xt.on||e.touches.length!==2){xo=null;return}e.preventDefault();let t=Math.hypot(e.touches[0].clientX-e.touches[1].clientX,e.touches[0].clientY-e.touches[1].clientY);xo!==null&&(At.fov=Nn.clamp(At.fov*(xo/t),35,85),Xt.baseFov=At.fov,At.updateProjectionMatrix(),wn(`FOV ${At.fov.toFixed(0)}\xB0`,800)),xo=t},{passive:!1}),s.addEventListener("touchend",()=>{xo=null})}function _g(){for(An=[];yi.children.length;)yi.children.pop();for(;ki.children.length;)ki.children.pop()}function ra(s){xs=s%ia.length,rh=ia[xs][0],qt.scale.setScalar(rh),Je("btn-scale").textContent=ia[xs][1]}function HS(){Je("btn-back").onclick=()=>{Mt?.xr.getSession()?.end(),Xt.on&&xg(),Je("viewer").style.display="none",Je("home").style.display="block"},Je("btn-camar").onclick=()=>OS(),Je("btn-scale").onclick=()=>ra(xs+1),Je("btn-light").onclick=()=>{Kf=!Kf,fg()},Je("btn-clear").onclick=_g,document.querySelectorAll("#toolbar [data-tool]").forEach(s=>{s.onclick=()=>oh(s.dataset.tool)}),Je("btn-chat").onclick=()=>{Je("chat").style.display="flex"},Je("btn-chat-close").onclick=()=>{Je("chat").style.display="none"},Je("chatform").onsubmit=s=>{s.preventDefault();let e=Je("chat-in").value.trim();if(e){if(Je("chat-in").value="",!ah?.has_ai){Jf("\u26A0 This session has no instance store (scene_r.db) \u2014 run the segmentation + store build first, then the AI can measure it.","");return}FS(e)}}}HS();xS();
