...
| F1 | pending | 508f327 | base = run6 + B + D (hybrid_da3 OFF, fine_register OFF) + **E-full pose_refine**: joint point-to-plane pose optimization (global ICP over 210 poses, odometry+leash priors, fresh-measure gate ≥10% or identity). Synthetic: layering 31→14 mm | | questions: layering/drift down? serpenteado (pose component)? end-of-walk? duplicates? |
