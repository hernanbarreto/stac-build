...
| A2 | pending | 0cc1858 | `elastic_seam: false` (flag now configurable; expect depth-cap far-drop self-off — not a density gain) | | question: serpenteado in overlap bands gone? |
