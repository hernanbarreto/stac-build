...
| F2 | pending | 1867dd9 | pose_refine far-field: max_depth 8→30 m with (8/z)² match weights (far landmarks anchor rotations), pair_window 10→15 (distant observers connected) | | question: chimney (~704) solid again while keeping F1 gains? Beats run 6? |
